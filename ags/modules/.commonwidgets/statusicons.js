...
const AudioLevelIndicator = () => Widget.Stack({
    transition: 'crossfade',
    transitionDuration: userOptions.animations.durationSmall,
    children: {
            'mute': Widget.Label({ className: 'txt-hugeass icon-material', label: 'no_sound' }),
            '1': Widget.Label({ className: 'txt-hugeass icon-material', label: 'volume_mute' }),
            '2': Widget.Label({ className: 'txt-hugeass icon-material', label: 'volume_down' }),
            '3': Widget.Label({ className: 'txt-hugeass icon-material', label: 'volume_up' }),
    ...
    setup: (self) => self.hook(Audio, stack => {
        ...
        if (audio.speaker.is_muted){
          ...
          stack.shown = String(Math.ceil(volume/30));
        }
    }),
});
