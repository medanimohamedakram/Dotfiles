...
function calculateSchemeInitIndex(optionsArr, searchValue = 'scheme-content') {
  if (searchValue == '')
    searchValue = 'scheme-content';
...
const initBlur = Utils.exec('bash -c "sed -n \'3p\' $HOME/.cache/ags/user/colormode.txt"');
const initBlurIndex = (initBlur == "blur = true") ? 1 : 0;
