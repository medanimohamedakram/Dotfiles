...
const HpackStartLabel = (label) => Widget.Label({
    label: label,
    hpack: "start"
});
...
const DeviceItem = (device) => Widget.Button({
    class_name: "row",
    ...
    on_secondary_click_release: (self, event) => {
        var _a;
        (_a = DeviceMenu(device)) === null || _a === void 0 ? void 0 : _a.popup_at_pointer(event);
    },
    child: Widget.Box({
